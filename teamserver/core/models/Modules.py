...
def search_modules():
    ...
    for module in show:
        arr = os.listdir(f"{os.curdir}/core/module/{module}")
        for x in arr:
            if "__" in x:
                continue
            elif ".git" in x:
    ...
    for module in show:
        ...
        for x in arr:
            if "__" in x:
                ...
                thedir = mod.split("/")[0]
                sys.path.insert(0, f"{os.curdir}/core/module/{thedir}")
...
def set_module():
    ...
    try:
        thedir = module.split("/")[0]
        import sys
        sys.path.insert(0, f"{os.curdir}/core/module/{module}")
